...
export default function Controls({ onLeave }) {
  ...
  // Sync state with LiveKit participant
  useEffect(() => {
  ...
  const toggleScreen = async () => {
    ...
    try {
      ...
      // User cancelled the browser permission dialog — no-op
    ...
    <div className={styles.bar}>
      ...
      <div className={styles.centre}>
        ...
        >
          ...
          <span className={styles.label}>{micEnabled ? 'Mute' : 'Unmuted'}</span>
        </ControlButton>
        ...
        >
          ...
          <span className={styles.label}>{camEnabled ? 'Camera' : 'No cam'}</span>
        </ControlButton>

        {/* End call — visually centred between cam and screenshare */}
        <button
        ...
        >
          <ScreenIcon />
          <span className={styles.label}>{screenEnabled ? 'Sharing' : 'Share'}</span>
        </ControlButton>

        {/* More options placeholder — extend as needed */}
        <ControlButton on={false} onClick={() => {}} title="More options (coming soon)" disabled>
          <MoreIcon />
...
function ControlButton({ children, on, onClick, title, offClass, onClass, disabled }) {
  return (
    <button
      className={`
        ${styles.ctrlBtn}
